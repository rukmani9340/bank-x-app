...
import com.bankx.application.repository.UserRepository;
...
public class AccountResource {
    ...
    public void registerAccount(@Valid @RequestBody ManagedUserVM managedUserVM, @RequestParam(name = "type", required = true) String type) {
        if (isPasswordLengthInvalid(managedUserVM.getPassword())) {
            throw new InvalidPasswordException();
        }
        User user = userService.registerUser(managedUserVM, managedUserVM.getPassword(), type.toLowerCase());
        mailService.sendActivationEmail(user, managedUserVM.getPassword(), type.toLowerCase());
